...
public class ProtoConstant {
    ...
    public final static ThreadLocal<List<Integer>> MESSAGE_PATH_LIST = ThreadLocal.withInitial(() -> Arrays.asList(4, 0, 2, 0));

    public static List<Integer> modifyMessagePath(int messageIndex, int fieldIndex) {
